  ...
  return (
    <div className="card p-5 border-l-4 border-l-indigo-400">
      ...
      <p className="text-sm text-gray-500 mt-2 leading-relaxed">
        Claude, GPT-4o mini, Gemini, and Grok each predict every FIFA World Cup 2026 match — scored live against the real results. Every prediction is already locked in before kick-off.
      </p>
      {days > 0 && (
